...
func (o *bridgeOwner) startInit(
	...
	workerHeartbeatIntervalMillis, err := workerHeartbeatIntervalMillis(workflowOptions)
	if err != nil {
		return err
	}
	_, err = o.requireSuccess(
...
// workerHeartbeatIntervalMillis validates the interval Core uses to report worker
// status. Zero disables reporting; Core itself rejects out-of-range positive values.
